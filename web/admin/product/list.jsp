                    ...
                    <c:forEach items="${list }" var="p" varStatus="vs">
                        <tr onmouseover="this.style.backgroundColor = 'white'"
                            ...
                            <td align="center" style="HEIGHT: 22px">
                                <a href="${ pageContext.request.contextPath }/adminProduct?method=getById&pid=${p.pid}">
                            ...
                            <td align="center" style="HEIGHT: 22px">
                                <a href="javascript:void(0)" onclick="deleteP('${p.pid}')">
...
<script type="text/javascript">
    function deleteP(pid) {
        if (confirm("您确定要删除该分类吗?")) {
            location.href = "${ pageContext.request.contextPath }/adminProduct?method=delete&pid=" + pid;
